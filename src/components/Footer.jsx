...
const Footer = () => (
  <footer className="gradient-bg py-12 border-t border-white/10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
        ...
        >
          <ul className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <li><a href="#projects" className="text-white/60 hover:text-white transition-colors duration-300">Works</a></li>
