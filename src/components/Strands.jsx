  ...
  useEffect(() => {
    ...
    const update = t => {
      ...
      if (cur.glass) {
        ...
        glassProgram.uniforms.uRefraction.value = cur.refraction;
        glassProgram.uniforms.uDispersion.value = cur.dispersion;
        glassProgram.uniforms.uRadius.value     = 0.46 * cur.glassSize;
